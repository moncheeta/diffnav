...
func chromeColors() map[Key]color.RGBA {
	if lightAppearance() {
		return map[Key]color.RGBA{
			...
			SelectBg:       {R: 0x20, G: 0x5E, B: 0xA6, A: 0xFF}, // blue-600
			SelectFg:       {R: 0xFF, G: 0xFC, B: 0xF0, A: 0xFF}, // paper
		}
	}
	return map[Key]color.RGBA{
		...
		SelectBg:       {R: 0x43, G: 0x85, B: 0xBE, A: 0xFF}, // blue-400
		SelectFg:       {R: 0x10, G: 0x0F, B: 0x0F, A: 0xFF}, // black
	}
}
